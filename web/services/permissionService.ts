...
export const PERMISSION_CATALOG: Record<PermissionNode, PermissionMetadata> = {
    ...
    'tenant.finance.accounts.manage': { scope: 'tenant', description: 'Manage chart of accounts and account mappings', dangerLevel: 'high' },
    'tenant.finance.ledger.post': { scope: 'tenant', description: 'Post journal entries in ledger', dangerLevel: 'high' },
    'tenant.finance.ar.manage': { scope: 'tenant', description: 'Manage accounts receivable (customers, invoices, dunning)', dangerLevel: 'high' },
    'tenant.finance.ap.manage': { scope: 'tenant', description: 'Manage accounts payable (vendors, bills, due items)', dangerLevel: 'high' },
    'tenant.finance.tax.manage': { scope: 'tenant', description: 'Manage tax codes, reports, and tax periods', dangerLevel: 'high' },
    'tenant.finance.close': { scope: 'tenant', description: 'Run monthly close and reopen periods', dangerLevel: 'high' },
    'tenant.finance.export.datev': { scope: 'tenant', description: 'Generate DATEV exports', dangerLevel: 'high' },
    'tenant.finance.audit.view': { scope: 'tenant', description: 'View finance audit trails' },
    'tenant.finance.reconciliation.manage': { scope: 'tenant', description: 'Manage bank reconciliation workflows', dangerLevel: 'high' },
