        ...
        for (const initiative of initiatives) {
            ...
            if (titleMatch || descMatch || statusMatch || outcomeMatch || successMetricMatch) {
                ...
                results.push({
                    ...
                    tenantId: initiative.tenantId || project?.tenantId || tenantId,
                    companyProjectId: project?.companyProjectId,
                    companyProjectTitle: companyProject?.title,
        ...
        for (const task of tasks) {
            ...
            if (titleMatch || descMatch) {
                ...
                results.push({
                    ...
                    projectTitle: project?.title,
                    tenantId: task.tenantId || project?.tenantId || tenantId,
                    companyProjectId: project?.companyProjectId,
                    companyProjectTitle: companyProject?.title,
        ...
        for (const issue of issues) {
            ...
            if (titleMatch || descMatch) {
                ...
                results.push({
                    ...
                    projectTitle: project?.title,
                    tenantId: (issue as any).tenantId || project?.tenantId || tenantId,
                    companyProjectId: project?.companyProjectId,
                    companyProjectTitle: companyProject?.title,
                    status: issue.status,
                    relevance: titleMatch ? 8 : 4
        ...
        for (const idea of ideas) {
            ...
            if (titleMatch || descMatch) {
                ...
                results.push({
                    ...
                    projectTitle: project?.title,
                    tenantId: (idea as any).tenantId || project?.tenantId || tenantId,
                    companyProjectId: project?.companyProjectId,
                    companyProjectTitle: companyProject?.title,
                    status: idea.stage,
                    relevance: titleMatch ? 8 : 4
