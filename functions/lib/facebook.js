...
exports.getFacebookAuthUrl = functions.region('europe-west3').https.onCall(async (data, context) => {
    if (!context.auth) {
...
exports.facebookCallback = functions.region('europe-west3').https.onRequest(async (req, res) => {
    var _a, _b;
    ...
    try {
        ...
        const integrationData = {
            platform: 'FacebookData',
            projectId,
            authUserId: userId,
            facebookUserId: userData.id,
            username: userData.name,
            profilePictureUrl: ((_b = (_a = userData.picture) === null || _a === void 0 ? void 0 : _a.data) === null || _b === void 0 ? void 0 : _b.url) || '',
