...
const projectflow_api_1 = require("./projectflow-api");
...
exports.newsletterSubscribe = functions.region(REGION).https.onRequest((req, res) => {
    return (0, corsConfig_1.corsMiddleware)(req, res, async () => {
        ...
        // Validate token
        const validation = await (0, authUtils_1.validateAPIToken)(token, 'newsletter:write');
        if (!validation.valid) {
...
exports.api = functions.region(REGION).https.onRequest((req, res) => {
    return (0, corsConfig_1.corsMiddleware)(req, res, async () => {
        ...
        if (path.startsWith('/projectflow') || path.startsWith('/api/projectflow')) {
            return (0, projectflow_api_1.handleProjectflowApiRoute)(req, res, path);
        }
