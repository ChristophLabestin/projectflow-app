...
const createTask = async (req: any, res: any, projectId: string) => {
    ...
    const payload = compactObject({
        ...
        templateId: getString(body.templateId),
        templateTrack: getString(body.templateTrack),
        templateSeedId: getString(body.templateSeedId),
        sourceReferences: Array.isArray(body.sourceReferences) ? body.sourceReferences : [],
        githubRepo: getString(body.githubRepo),
        githubIssueNumber: typeof body.githubIssueNumber === 'number' ? body.githubIssueNumber : undefined,
        githubIssueUrl: getString(body.githubIssueUrl),
        githubIssueNodeId: getString(body.githubIssueNodeId),
        githubIssueState: getString(body.githubIssueState),
        githubProjectV2Fields: getRecord(body.githubProjectV2Fields),
        githubSyncDisabled: typeof body.githubSyncDisabled === 'boolean' ? body.githubSyncDisabled : undefined,
