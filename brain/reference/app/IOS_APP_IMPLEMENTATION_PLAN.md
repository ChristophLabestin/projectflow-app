...
- `brain/reference/app/APP_DOCS_INDEX.md` (starting index for project rules)
- `brain/reference/app/APP_CONCEPT.md` (modules, tiers, data model, flows)
- `brain/reference/app/PERMISSIONS.md` (role gating + action rules)
- `brain/reference/app/FIRESTORE_STRUCTURE.md` (collections/paths)
- `brain/reference/app/STYLING.md` and `brain/reference/legacy-agent/STYLING.md` (design tokens + SCSS design language to mirror)
- `brain/reference/app/COMPONENTS.md` (UI patterns to mirror in SwiftUI)
- `brain/reference/app/SITEMAP.md` (page coverage; exclude social/marketing)
...
- Use Firestore as the source of truth and keep parity with `firestore.rules` and `brain/reference/app/FIRESTORE_STRUCTURE.md`.

## Design System & Theming
- Mirror the monochrome design language from `brain/reference/app/STYLING.md`. Map SCSS tokens to SwiftUI Colors/Typography/Spacing.
- Create a centralized Theme layer with light/dark mode support that follows the web token hierarchy.
- Build a small reusable component set (Button, Card, Input, Modal/Sheet, Badge, EmptyState, ListRow) that maps to `brain/reference/app/COMPONENTS.md`.
...
- Enforce permission checks per `brain/reference/app/PERMISSIONS.md` on all write operations and privileged reads.
- Align data models to `brain/reference/app/FIRESTORE_STRUCTURE.md` for Projects, Tasks, Flows, Issues, Notifications, and Pinned items.
...
- [x] Create a shared `Theme` module mirroring `brain/reference/app/STYLING.md` tokens (light + dark).
- [x] Build core SwiftUI components aligned with `brain/reference/app/COMPONENTS.md`.
...
- [x] Implement permission checks based on `brain/reference/app/PERMISSIONS.md` for all write actions.
- [x] Create Firestore models + repositories aligned with `brain/reference/app/FIRESTORE_STRUCTURE.md`.
...
- [x] Document iOS module coverage and MVP exclusions in `brain/reference/app/SITEMAP.md`.
