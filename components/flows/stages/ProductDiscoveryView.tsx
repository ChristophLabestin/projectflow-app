        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 h-full">
            ...
            <div className="col-span-1 flex flex-col h-full bg-white dark:bg-slate-900/50 rounded-2xl border border-[var(--color-surface-border)] shadow-sm p-6 relative overflow-hidden">
                ...
                <div className="flex flex-col h-full relative z-10">
                    {/* Header */}
                    <div className="mb-6">
                        <h2 className="text-xl font-extrabold text-[var(--color-text-main)] tracking-tight">Discovery</h2>
                        <p className="text-xs text-[var(--color-text-muted)] mt-1">Research users and market landscape</p>
                    ...
                    <div className="space-y-4 mb-6">
                        <div>
                            <label className="text-xs font-bold text-[var(--color-text-muted)] uppercase tracking-wider mb-1.5 block">Market Size (TAM)</label>
                            <input
                                type="text"
                        ...
                        <div>
                            <label className="text-xs font-bold text-[var(--color-text-muted)] uppercase tracking-wider mb-1.5 block">Target Segment</label>
                            <input
                                type="text"
                    ...
                    <div className="flex-1 flex flex-col min-h-0">
                        ...
                        <textarea
                            ...
                            placeholder="Document insights from user interviews, surveys..."
                        />
                    </div>
                    ...
                    <div className="mt-4 pt-4 border-t border-[var(--color-surface-border)]">
                        ...
                        >
                            <span className="font-bold pl-1">Advance to Definition</span>
                ...
                <div className="flex-1 overflow-y-auto space-y-3 pr-1">
                    ...
                    >
                        ...
                        <div className="text-left">
                            <p className="text-sm font-medium text-[var(--color-text-muted)] group-hover:text-[var(--color-text-main)]">Add Persona</p>
                            <p className="text-xs text-[var(--color-text-subtle)]">Define a target user</p>
                        </div>
                    </button>

                    {discoveryData.personas.length === 0 ? (
                        <div className="text-center py-8 text-[var(--color-text-muted)]">
                            <p className="text-xs">No personas yet — add manually or use AI</p>
                        </div>
                    ) : (
                            ...
                            >
                                ...
                                {selectedPersona === index && (
                                    <div className="mt-4 pt-4 border-t border-[var(--color-surface-border)] space-y-3" onClick={(e) => e.stopPropagation()}>
                                        <div>
                                            <label className="text-[10px] font-medium text-[var(--color-text-muted)] uppercase mb-1 block">Pain Points</label>
                                            <textarea
                                        ...
                                        <div>
                                            <label className="text-[10px] font-medium text-[var(--color-text-muted)] uppercase mb-1 block">Goals</label>
                                            <textarea
            ...
            <div className="col-span-1 flex flex-col h-full bg-white dark:bg-slate-900/50 rounded-2xl border border-[var(--color-surface-border)] shadow-sm p-6 overflow-hidden">
                ...
                <div className="flex-1 overflow-y-auto space-y-3 pr-1">
                    ...
                    >
                        ...
                        <div className="text-left">
                            <p className="text-sm font-medium text-[var(--color-text-muted)] group-hover:text-[var(--color-text-main)]">Add Competitor</p>
                            <p className="text-xs text-[var(--color-text-subtle)]">Analyze the competition</p>
                        </div>
                    </button>

                    {discoveryData.competitors.length === 0 ? (
                        <div className="text-center py-8 text-[var(--color-text-muted)]">
                            <p className="text-xs">No competitors yet — add manually or use AI</p>
                        </div>
                    ) : (
                        discoveryData.competitors.map((competitor: Competitor, index: number) => (
                            <div key={index} className="p-4 rounded-xl border border-[var(--color-surface-border)] hover:border-[var(--color-text-muted)] transition-all space-y-3">
                                ...
                                <div>
                                    <label className="text-[10px] font-medium text-[var(--color-text-muted)] uppercase mb-1 block">Strengths</label>
                                    <textarea
                                ...
                                <div>
                                    <label className="text-[10px] font-medium text-[var(--color-text-muted)] uppercase mb-1 block">Weaknesses</label>
                                    <textarea
