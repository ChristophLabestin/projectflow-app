    ...
    return (
        <div className="flex flex-col items-center justify-center h-full max-w-4xl mx-auto p-6">
            <div className="text-center mb-12">
                <h2 className="text-3xl font-bold text-[var(--color-text-main)] mb-4">{t('flowStages.marketingType.title')}</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full">
                ...
                <button
                    ...
                    className="group relative flex flex-col p-8 rounded-2xl border-2 border-[var(--color-surface-border)] hover:border-violet-500 bg-[var(--color-surface-paper)] hover:bg-[var(--color-surface-hover)] transition-all duration-200 text-left"
                >
                    ...
                    <h3 className="text-xl font-bold text-[var(--color-text-main)] mb-2">{t('flowStages.marketingType.paidAd.title')}</h3>
                ...
                <button
                    ...
                    className="group relative flex flex-col p-8 rounded-2xl border-2 border-[var(--color-surface-border)] hover:border-orange-500 bg-[var(--color-surface-paper)] hover:bg-[var(--color-surface-hover)] transition-all duration-200 text-left"
                >
                    ...
                    <h3 className="text-xl font-bold text-[var(--color-text-main)] mb-2">{t('flowStages.marketingType.emailMarketing.title')}</h3>
                    <p className="text-[var(--color-text-muted)] mb-6 leading-relaxed">
