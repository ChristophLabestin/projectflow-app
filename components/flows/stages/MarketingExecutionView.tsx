        ...
        return (
            <div className="grid grid-cols-1 gap-6 h-full">
                <div className="bg-white dark:bg-slate-900/50 rounded-2xl border border-[var(--color-surface-border)] shadow-sm p-8 flex flex-col items-center justify-center text-center">
                    ...
                    <h2 className="text-2xl font-bold text-[var(--color-text-main)] mb-2">{t('flowStages.marketingExecution.live.title')}</h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 h-full">
            <div className="col-span-1 lg:col-span-2 flex flex-col h-full bg-white dark:bg-slate-900/50 rounded-2xl border border-[var(--color-surface-border)] shadow-sm p-6">
                <div className="mb-6 flex items-center justify-between">
                    <div>
                        <h2 className="text-xl font-extrabold text-[var(--color-text-main)] tracking-tight">{t('flowStages.marketingExecution.title')}</h2>
                        <p className="text-xs text-[var(--color-text-muted)] mt-1">{t('flowStages.marketingExecution.subtitle')}</p>
                    </div>
                ...
                <div className="grid grid-cols-2 gap-6 mb-6">
                    <div>
                        <label className="text-xs font-bold text-[var(--color-text-muted)] uppercase tracking-wider mb-2 block">{t('flowStages.marketingExecution.startDate')}</label>
                        <DatePicker
                    ...
                    <div>
                        <label className="text-xs font-bold text-[var(--color-text-muted)] uppercase tracking-wider mb-2 block">{t('flowStages.marketingExecution.endDate')}</label>
                        <DatePicker
                ...
                <div className="space-y-3">
                    <div className="flex items-center justify-between">
                        <label className="text-xs font-bold text-[var(--color-text-muted)] uppercase tracking-wider">{t('flowStages.marketingExecution.tracking.label')}</label>
                    ...
                    {execution.trackingLinks.length === 0 && <p className="text-xs text-[var(--color-text-muted)] italic">{t('flowStages.marketingExecution.tracking.empty')}</p>}
                </div>
            ...
            <div className="col-span-1 flex flex-col h-full bg-white dark:bg-slate-900/50 rounded-2xl border border-[var(--color-surface-border)] shadow-sm p-6 overflow-hidden">
                <h3 className="font-bold text-[var(--color-text-main)] mb-4">{t('flowStages.marketingExecution.budget.title')}</h3>
                <div>
                    <label className="text-xs font-bold text-[var(--color-text-muted)] uppercase tracking-wider mb-1.5 block">{t('flowStages.marketingExecution.budget.approved')}</label>
                    <div className="text-2xl font-mono font-bold text-[var(--color-text-main)] mb-4">$5,000.00</div>

                    <label className="text-xs font-bold text-[var(--color-text-muted)] uppercase tracking-wider mb-1.5 block">{t('flowStages.marketingExecution.budget.actual')}</label>
