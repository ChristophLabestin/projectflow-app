        ...
        <div className="px-6 py-6 space-y-10">
            ...
            <div className="rounded-[28px] border border-[var(--color-surface-border)] bg-gradient-to-br from-[var(--color-surface-card)] to-[var(--color-surface-bg)] p-6">
                ...
                <div className="flex items-center gap-4 mt-6">
                    <div className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-[var(--color-primary)]/10 text-[var(--color-primary)] text-xs font-bold">
            ...
            {/* SECTION: Overview */}
            <section data-section-id="sprint-overview" className="help-section rounded-3xl border border-[var(--color-surface-border)] bg-[var(--color-surface-bg)] p-6 space-y-6">
                <div className="flex items-start justify-between">
                    <div>
                        <div className="text-[10px] font-bold uppercase tracking-[0.28em] text-[var(--color-text-muted)]">Workflow</div>
                        <h3 className="text-xl font-bold text-[var(--color-text-main)] mt-2">The Sprint Lifecycle</h3>
                    ...
                    <span className="material-symbols-outlined text-[20px] text-[var(--color-text-subtle)]">sync</span>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div className="rounded-2xl border border-[var(--color-surface-border)] bg-[var(--color-surface-card)] p-5">
                        <div className="flex items-center gap-2 mb-3">
                            ...
                            <span className="text-sm font-bold text-[var(--color-text-main)]">1. Planning</span>
                        </div>
                    ...
                    <div className="rounded-2xl border border-[var(--color-surface-border)] bg-[var(--color-surface-card)] p-5">
                        <div className="flex items-center gap-2 mb-3">
                            ...
                            <span className="text-sm font-bold text-[var(--color-text-main)]">2. Active</span>
                        </div>
                        <p className="text-xs text-[var(--color-text-muted)] leading-relaxed">
                    ...
                    <div className="rounded-2xl border border-[var(--color-surface-border)] bg-[var(--color-surface-card)] p-5">
                        <div className="flex items-center gap-2 mb-3">
                            ...
                            <span className="text-sm font-bold text-[var(--color-text-main)]">3. Completed</span>
                        </div>
                        <p className="text-xs text-[var(--color-text-muted)] leading-relaxed">
            ...
            <section data-section-id="backlog-planning" className="help-section rounded-3xl border border-[var(--color-surface-border)] bg-[var(--color-surface-card)] p-6 space-y-6">
                <div className="flex items-start justify-between">
                    <div>
                        <div className="text-[10px] font-bold uppercase tracking-[0.28em] text-[var(--color-text-muted)]">Organization</div>
                        <h3 className="text-xl font-bold text-[var(--color-text-main)] mt-2">Backlog & Planning</h3>
                        <p className="text-sm text-[var(--color-text-muted)] mt-2 max-w-xl leading-relaxed">
                ...
                <div className="space-y-4">
                    <div className="flex items-start gap-4">
                        <div className="size-8 rounded-full bg-[var(--color-primary)]/10 flex items-center justify-center shrink-0">
                            <span className="material-symbols-outlined text-[16px] text-[var(--color-primary)]">drag_indicator</span>
                        </div>
                        <div>
                            <div className="text-sm font-bold text-[var(--color-text-main)]">Drag and Drop</div>
                    ...
                    <div className="flex items-start gap-4">
                        ...
                        <div>
                            <div className="text-sm font-bold text-[var(--color-text-main)]">Smart Sorting</div>
                            <p className="text-xs text-[var(--color-text-muted)] mt-1">
            ...
            <section data-section-id="active-sprint" className="help-section rounded-3xl border border-[var(--color-surface-border)] bg-[var(--color-surface-bg)] p-6 space-y-6">
                <div className="flex items-start justify-between">
                    <div>
                        <div className="text-[10px] font-bold uppercase tracking-[0.28em] text-[var(--color-text-muted)]">Focus</div>
                        <h3 className="text-xl font-bold text-[var(--color-text-main)] mt-2">Active Sprint Board</h3>
                        <p className="text-sm text-[var(--color-text-muted)] mt-2 max-w-xl leading-relaxed">
                            Once a sprint is started, the view switches to a focused Kanban board showing only that sprint's tasks.
                        </p>
                    </div>
                    <span className="material-symbols-outlined text-[20px] text-[var(--color-text-subtle)]">view_kanban</span>
                </div>
                ...
                <div className="rounded-2xl border border-[var(--color-surface-border)] bg-[var(--color-surface-card)] p-5">
                    ...
                    <ul className="space-y-3">
                        <li className="flex items-center gap-3 text-sm text-[var(--color-text-main)]">
                            <span className="material-symbols-outlined text-[18px] text-[var(--color-text-subtle)]">check</span>
