...
const ProgressStep = ({
    ...
    <div className="flex items-center gap-3">
        ...
        <span className={`text-sm font-medium ${isActive ? 'text-main' : 'text-muted'}`}>
            {title}
        </span>
    </div>
);
...
const AnatomyLabel = ({
    ...
    <div className={`absolute ${position} z-10`}>
        <div className="bg-card border border-surface rounded-xl p-3 shadow-lg max-w-[180px]">
            <div className="text-xs font-bold text-primary uppercase tracking-wider">{label}</div>
            <div className="text-[11px] text-muted mt-1 leading-relaxed">{description}</div>
        </div>
    </div>
);

const Keycap = ({ children }: { children: React.ReactNode }) => (
    <span className="px-2 py-1 rounded-lg border border-surface bg-card text-xs font-semibold text-main font-mono">
        {children}
    </span>
);
...
const ConceptCard = ({
    ...
    <div className="rounded-2xl border border-surface bg-card p-5 space-y-3">
        <div className="flex items-center gap-3">
            ...
            <div className="text-base font-bold text-main">{title}</div>
        </div>
        ...
        <div className="flex flex-wrap gap-2">
            {examples.map((ex, i) => (
                <span
                    key={i}
                    className="px-2 py-1 rounded-lg bg-surface-hover text-[10px] font-medium text-muted"
                >
                    {ex}
                </span>
            ))}
...
const ActionStep = ({
    ...
    <div className="flex gap-4 items-start">
        ...
        <div className="flex-1 rounded-2xl border border-surface bg-card p-4">
...
const ShortcutRow = ({
    ...
    <div className="flex items-center justify-between py-3 border-b border-surface last:border-0">
        <div className="flex items-center gap-3">
            ...
            {context && (
                <span className="px-2 py-0.5 rounded-full bg-surface-hover text-[10px] text-muted">
                    {context}
                </span>
            )}
        </div>
...
const GlossaryTerm = ({
    ...
    <div className="rounded-xl border border-surface bg-card p-4">
        <div className="text-sm font-bold text-main">{term}</div>
        <p className="text-sm text-muted mt-2 leading-relaxed">{definition}</p>
        {relatedTerms && relatedTerms.length > 0 && (
            <div className="mt-3 flex items-center gap-2">
                <span className="text-[10px] text-subtle">Related:</span>
                {relatedTerms.map((t, i) => (
                    <span key={i} className="px-2 py-0.5 rounded-full bg-surface-hover text-[10px] text-muted">
                        {t}
                    </span>
                ))}
            </div>
...
export const GettingStartedPage = (_props: HelpCenterPageProps) => {
    return (
        <div className="px-6 py-6 space-y-10">
            ...
            <section data-section-id="workspace-anatomy" className="help-section rounded-3xl border border-surface bg-surface p-6 space-y-6">
                <div className="flex items-start justify-between">
                    <div>
                        <div className="text-[10px] font-bold uppercase tracking-[0.28em] text-muted">Interface</div>
                        <h3 className="text-xl font-bold text-main mt-2">Workspace Anatomy</h3>
                    ...
                    <span className="material-symbols-outlined text-[20px] text-subtle">dashboard</span>
                </div>

                {/* Visual Diagram */}
                <div className="relative rounded-2xl border-2 border-dashed border-surface bg-card p-4 min-h-[320px]">
                    {/* Sidebar Region */}
                    <div className="absolute left-4 top-4 bottom-4 w-[180px] rounded-xl border border-primary/30 bg-primary/5 flex flex-col items-center justify-center">
                        <span className="material-symbols-outlined text-[32px] text-primary/50">menu</span>
                        <span className="text-xs font-bold text-primary mt-2">SIDEBAR</span>
                    </div>
            ...
            <section data-section-id="core-concepts" className="help-section rounded-3xl border border-surface bg-card p-6 space-y-6">
                <div className="flex items-start justify-between">
                    <div>
                        <div className="text-[10px] font-bold uppercase tracking-[0.28em] text-muted">Foundation</div>
                        <h3 className="text-xl font-bold text-main mt-2">Core Concepts</h3>
                        <p className="text-sm text-muted mt-2 max-w-xl leading-relaxed">
                    ...
                    <span className="material-symbols-outlined text-[20px] text-subtle">hub</span>
                </div>

                {/* Hierarchy Diagram */}
                <div className="rounded-2xl border border-surface bg-surface p-5">
                    <div className="text-xs font-bold uppercase tracking-wider text-muted mb-4">Hierarchy</div>
                    <div className="flex items-center gap-3 flex-wrap">
                        <div className="px-4 py-2 rounded-xl bg-primary text-on-primary font-bold text-sm">Workspace</div>
                        <span className="material-symbols-outlined text-subtle">arrow_forward</span>
                        <div className="px-4 py-2 rounded-xl bg-primary/80 text-on-primary font-bold text-sm">Projects</div>
                        <span className="material-symbols-outlined text-subtle">arrow_forward</span>
                        <div className="px-4 py-2 rounded-xl bg-primary/60 text-on-primary font-bold text-sm">Modules</div>
                        <span className="material-symbols-outlined text-subtle">arrow_forward</span>
                        <div className="px-4 py-2 rounded-xl bg-primary/40 text-on-primary font-bold text-sm">Items</div>
                    </div>
                </div>
            ...
            <section data-section-id="first-five-minutes" className="help-section rounded-3xl border border-surface bg-surface p-6 space-y-6">
                <div className="flex items-start justify-between">
                    <div>
                        <div className="text-[10px] font-bold uppercase tracking-[0.28em] text-muted">Quick Start</div>
                        <h3 className="text-xl font-bold text-main mt-2">Your First 5 Minutes</h3>
                        <p className="text-sm text-muted mt-2 max-w-xl leading-relaxed">
            ...
            <section data-section-id="navigation-mastery" className="help-section rounded-3xl border border-surface bg-card p-6 space-y-6">
                <div className="flex items-start justify-between">
                    <div>
                        <div className="text-[10px] font-bold uppercase tracking-[0.28em] text-muted">Movement</div>
                        <h3 className="text-xl font-bold text-main mt-2">Navigation Mastery</h3>
                        <p className="text-sm text-muted mt-2 max-w-xl leading-relaxed">
                            Learn the four navigation systems and when to use each one for maximum speed.
                        </p>
                    </div>
                    <span className="material-symbols-outlined text-[20px] text-subtle">explore</span>
                </div>

                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="rounded-2xl border border-surface bg-surface p-5 space-y-4">
                        <div className="flex items-center gap-3">
                            <div className="w-10 h-10 rounded-xl bg-primary/10 flex items-center justify-center">
                                <span className="material-symbols-outlined text-[20px] text-primary">menu</span>
                            </div>
                            <div>
                                <div className="text-sm font-bold text-main">Sidebar</div>
                                <div className="text-xs text-muted">Primary navigation</div>
                            </div>
                        </div>
                        <p className="text-sm text-muted leading-relaxed">
                            The sidebar is context-aware. At workspace level, it shows global pages. Inside a project, it shows project modules.
                        </p>
                        <div className="text-xs text-primary font-medium">Best for: Switching between modules and projects</div>
                    </div>
                    ...
                    <div className="rounded-2xl border border-surface bg-surface p-5 space-y-4">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <div className="text-sm font-bold text-main">Breadcrumbs</div>
                                <div className="text-xs text-muted">Location awareness</div>
                            </div>
                        </div>
                        <p className="text-sm text-muted leading-relaxed">
                    ...
                    <div className="rounded-2xl border border-surface bg-surface p-5 space-y-4">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <div className="text-sm font-bold text-main">Global Search</div>
                                <div className="text-xs text-muted">Find anything</div>
                            </div>
                        </div>
                        <p className="text-sm text-muted leading-relaxed">
                    ...
                    <div className="rounded-2xl border border-surface bg-surface p-5 space-y-4">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <div className="text-sm font-bold text-main">Keyboard Shortcuts</div>
                                <div className="text-xs text-muted">Power user mode</div>
                            </div>
                        </div>
                        <p className="text-sm text-muted leading-relaxed">
            ...
            <section data-section-id="keyboard-shortcuts" className="help-section rounded-3xl border border-surface bg-surface p-6 space-y-6">
                <div className="flex items-start justify-between">
                    <div>
                        <div className="text-[10px] font-bold uppercase tracking-[0.28em] text-muted">Hotkeys</div>
                        <h3 className="text-xl font-bold text-main mt-2">Keyboard Shortcuts</h3>
                        <p className="text-sm text-muted mt-2 max-w-xl leading-relaxed">
                            Complete reference for all keyboard shortcuts. These work from anywhere in the app when a project is pinned.
                        </p>
                    </div>
                    <span className="material-symbols-outlined text-[20px] text-subtle">keyboard</span>
                </div>
            ...
            {/* SECTION: Glossary */}
            <section data-section-id="glossary" className="help-section rounded-3xl border border-surface bg-card p-6 space-y-6">
                <div className="flex items-start justify-between">
                    <div>
                        <div className="text-[10px] font-bold uppercase tracking-[0.28em] text-muted">Reference</div>
                        <h3 className="text-xl font-bold text-main mt-2">Glossary of Terms</h3>
                        <p className="text-sm text-muted mt-2 max-w-xl leading-relaxed">
                            Quick definitions for all terminology used throughout ProjectFlow.
                        </p>
                    </div>
                    <span className="material-symbols-outlined text-[20px] text-subtle">dictionary</span>
                </div>
            ...
            <div className="rounded-2xl border border-surface bg-card p-5">
                <div className="flex items-start gap-3">
                    ...
                    <div>
                        <div className="text-sm font-bold text-main">You're ready to go!</div>
