                                        ...
                                        <h3 className="font-bold text-[var(--color-text-main)] flex items-center gap-2">
                                            ...
                                            {activeProjectUsers.length > 0 && (
                                                <span className="text-xs font-medium text-emerald-600 dark:text-emerald-400 bg-emerald-50 dark:bg-emerald-900/20 px-2 py-0.5 rounded-full flex items-center gap-1">
                                                    ...
                                                    {t('projectOverview.team.active').replace('{count}', String(activeProjectUsers.filter(u => u.isOnline || u.isBusy).length))}
                                                </span>
                                            )}
                                        </h3>
                                        <Link
                                                    ...
                                                    <div key={member.id} className="flex items-center gap-3 p-2 rounded-lg hover:bg-[var(--color-surface-hover)] transition-colors group/member">
                                                        ...
                                                        <div className="flex-1 min-w-0">
                                                            ...
                                                            <div className="flex items-center gap-2">
                                                                ...
                                                                {isOnline && (
                                                                    <span className="text-[10px] text-emerald-600 dark:text-emerald-400 font-medium">• {t('projectOverview.team.status.online')}</span>
                                                                )}
                                                                {isIdle && (
                                                                    <span className="text-[10px] text-amber-600 dark:text-amber-400 font-medium">• {t('projectOverview.team.status.away')}</span>
                                                                )}
                                                            </div>
                                                        </div>
                                                    </div>
                    ...
                    <div className="space-y-4">
                        <div className="aspect-video w-full bg-black rounded-xl overflow-hidden flex items-center justify-center relative group">
                            {projectAssets[selectedImageIndex] ? (
                                <>
                                    <img src={projectAssets[selectedImageIndex]} alt={t('projectOverview.gallery.imageAlt')} className="max-w-full max-h-[70vh] object-contain" />
                                ...
                                <p className="text-white/50">{t('projectOverview.gallery.empty')}</p>
                            )}
                        </div>
