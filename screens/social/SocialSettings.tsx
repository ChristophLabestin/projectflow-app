...
import { subscribeIntegrations, connectIntegration, disconnectIntegration } from '../../services/dataService';
import { SocialIntegration, SocialPlatform } from '../../types';
    ...
    return (
        <div className="max-w-4xl mx-auto space-y-8">
            <div>
                ...
                <p className="text-[var(--color-text-muted)]">Manage your connected social media accounts.</p>
            </div>
