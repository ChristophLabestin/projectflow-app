...
export const AccountingPlaceholder = () => {
    ...
    return (
        <div className="flex flex-col items-center justify-center h-full p-8 text-center animate-fade-in">
            ...
            <h1 className="text-3xl font-bold text-[var(--color-text-main)] mb-3">Accounting Module</h1>
            <p className="text-[var(--color-text-subtle)] max-w-md text-lg">
                This module is currently under development. It will allow you to manage project finances, invoices, and expenses.
            </p>
            <div className="mt-8 px-4 py-2 bg-[var(--color-surface-hover)] rounded-full text-xs font-semibold text-[var(--color-text-muted)] border border-[var(--color-surface-border)]">
                Coming Soon
            </div>
        </div>
    );
