...
struct ProjectMetrics: Equatable {
    ...
    static let empty = ProjectMetrics(taskCount: 0, taskCompleted: 0)
...
struct ProjectWorkloadSummary: Equatable {
    ...
    var hasSignals: Bool {
        urgentTasks > 0 || overdueCount > 0 || dueSoonCount > 0
...
final class ProjectInsightsStore: ObservableObject {
    ...
    private func refreshInsights() {
        ...
        let allLoaded = didLoadProjects && didLoadTasks && didLoadMilestones && didLoadSprints && didLoadActivities
